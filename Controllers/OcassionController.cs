...
{
    public class OcassionController : Controller
    {
        public readonly RepositoryOcassion _repositoryOcassion;
        public readonly RepositoryECard _repositoryECard;
        public OcassionController(RepositoryOcassion repositoryOcassion, RepositoryECard repositoryECard)
        {
            ...
            public IActionResult Index(int Id)
        {
            ...
            if (Id != 0)
            {
                ...
                ViewBag.GetAllClose = _repositoryOcassion.GetAllClose();
